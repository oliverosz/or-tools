...
ifeq ("$(VISUAL_STUDIO_YEAR)","2015")
  CCC=cl /EHsc $(MDFLAG) /nologo /D_SILENCE_STDEXT_HASH_DEPRECATION_WARNINGS
else
  CCC=cl /EHsc $(MDFLAG) /nologo
endif
...
ifeq ("$(WINDOWS_MDd)","MDd")
  DYNAMIC_PROTOBUF_LNK = $(PROTOBUF_DIR)\\lib\\libprotobufd.lib
  STATIC_PROTOBUF_LNK = $(PROTOBUF_DIR)\\lib\\libprotobufd.lib
else
  DYNAMIC_PROTOBUF_LNK = $(PROTOBUF_DIR)\\lib\\libprotobuf.lib
  STATIC_PROTOBUF_LNK = $(PROTOBUF_DIR)\\lib\\libprotobuf.lib
endif
